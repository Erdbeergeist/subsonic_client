...
BIN    = subsonic-client
OBJ    = subsonic-client.o core.o subsonicAPI.o mediaObjects.o curlwrapper.o vlcwrapper.o tinyxml2.o imguiwrapper.o $(IMGUI_DIR)/imgui.o $(IMGUI_DIR)/imgui_demo.o $(IMGUI_DIR)/imgui_draw.o $(IMGUI_DIR)/imgui_tables.o $(IMGUI_DIR)/imgui_widgets.o $(IMGUI_DIR)/backends/imgui_impl_glfw.o $(IMGUI_DIR)/backends/imgui_impl_opengl3.o
HEADER = subsonicAPI.h subsonic-client.h mediaObjects.h curlwrapper.h vlcwrapper.h tinyxml2.h imguiwrapper.h $(IMGUI_DIR)/imgui_impl_glfw.h $(IMGUI_DIR)/imgui_impl_opengl3.h $(IMGUI_DIR)/imgui.h
